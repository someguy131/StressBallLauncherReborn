...
def updateHDriveLeftAuto(value):
        try:
                #map the -1 to 1 value of the joystick motion
                #to a range of 500 to 2500, the pwm range of SparkMini ESCs
                pwmLeft = int(map(value, 1, -1, 500, 2500))
        except:
                #if something goes wrong, default the MCs to not move
                #likely cause would be controller disconnect
                print('failed to map values')
...
def updateHDriveRightAuto(value):
        try:
                #map the -1 to 1 value of the joystick motion
                #to a range of 500 to 2500, the pwm range of SparkMini ESCs
                pwmRight = int(map(value, -1, 1, 500, 2500))                                
        except:
                #if something goes wrong, default the MCs to not move
                #likely cause would be controller disconnect
                print('failed to map values')
...
#-----------------------STRAFE DRIVE-----------------------------
def updateHDriveStrafeAuto(value):
        try:
                #map the -1 to 1 value of the input value
                #to a range of 500 to 2500, the pwm range of SparkMini ESCs
                pwmStrafe = int(map(value, -1, 1, 500, 2500))
        except:
                #if something goes wrong, default the MCs to not move
                #likely cause would be controller disconnect
                print('failed to map values')
